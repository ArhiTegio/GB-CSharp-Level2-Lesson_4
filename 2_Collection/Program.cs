...
namespace _2_Collection
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var q = new Questions();
            WriteLine("С# - Уровень 2. Задание 4.2");
            WriteLine("Кузнецов");
            WriteLine($"2.Дана коллекция List<T>. Требуется подсчитать, сколько раз каждый элемент встречается в данной коллекции: {Environment.NewLine} a  для целых чисел;{Environment.NewLine} b *для обобщенной коллекции;{Environment.NewLine} c**используя Linq. + Environment.NewLine{Environment.NewLine}");
            WriteLine("");
            var r = new Random();
            //a
