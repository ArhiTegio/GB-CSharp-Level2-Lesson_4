...
namespace _3_OrderBy
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var q = new Questions();
            WriteLine("С# - Уровень 2. Задание 4.3");
            WriteLine("Кузнецов");
            WriteLine($"3* Дан фрагмент программы: {Environment.NewLine} а. Свернуть обращение к OrderBy с использованием лямбда-выражения =>.{ Environment.NewLine} b. * Развернуть обращение к OrderBy с использованием делегата");
            WriteLine("");
